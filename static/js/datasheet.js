...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const shell_mass_flow = thermalData.shell_flowrate * thermalData.shell_inlet_density;
    const tube_mass_flow = thermalData.tube_flowrate * thermalData.tube_inlet_density;
    ...
    createRow(tbody, ['Fluid Quantity, Total kg/s', format(shell_mass_flow, 4), '', format(tube_mass_flow, 4), '']);
